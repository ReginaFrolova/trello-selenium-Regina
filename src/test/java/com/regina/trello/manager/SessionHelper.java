package com.regina.trello.manager;
...
public class SessionHelper extends HelperBase{
    ...
    public void loginWhithBothAccs() throws InterruptedException {
      ...
      type(By.id("user"), "reginafrolova75@gmail.com");
      Thread.sleep(10000);
      if(wd.findElement(By.id("password")).isDisplayed()){
        type(By.id("password"), "916233020105r");
      }
      click(By.id("login"));
    ...
    public void loginAtlassianAcc() throws InterruptedException {
      clickLoginLink();
      fillLoginFormAtlassianAcc("reginafrolova75@gmail.com", "916233020105r");
      pause(20000);
